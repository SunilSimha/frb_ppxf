...
#
setup_keywords['name'] = 'pPXF'
setup_keywords['description'] = 'A fork of pPXF 6.7.17 for FRB hosts'
setup_keywords['author'] = 'Michele Cappellari, J. Xavier Prochaska, Sunil Simha'
setup_keywords['author_email'] = 'sunil.simha95@gmail.com'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/SunilSimha/frb_ppxf'

#
# END OF SETTINGS THAT NEED TO BE CHANGED.
#
setup_keywords['version'] = '6.7.17.dev0' #get_version(setup_keywords['name'])
#
...
setup_keywords['requires'] = ['Python (>3.8.0)', 'numpy', 'scipy', 'matplotlib', 'astropy']
setup_keywords['install_requires'] = ['numpy', 'scipy', 'matplotlib', 'astropy']
